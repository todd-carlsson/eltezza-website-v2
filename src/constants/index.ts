...
export const faqs = {
    design: [
        {
            ...
            answer: "Quite simply, scroll to the bottom of our site and submit your request!"
        },
        {
            id: "2",
        ...
        {
            id: "5",
            question: "Do you offer ongoing support or maintenance for projects after completion?",
            answer: "We offer web maintenance for our web projects, this will allow us to assist you with any updates you may have in the future on top of keeping you safe from any potential cyber-attacks. Whatever the project, we will always be here to help."
        },
        {
            id: "6",
    ...
    creative: [
        ...
        },
        {
            ...
            answer: "Our bread & butter are FMCG brands. Spanning from drinks all the way to crackers, we have the the know-how to get you seen."
        },
        {
            id: "3",
            question: "What is the typical timeline for project completion?",
            answer: "Depending on the services you require, our timeline ranges from 2 to 6 weeks."
        },
        {
            id: "4",
